    ...
    <body onload="time()" class="app sidebar-mini rtl">
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li><a class="app-menu__item" href="https://docs.google.com/spreadsheets/d/1LRmRIrC0qZYi27vLPY4oL-DSkEKPuaDB7OC5eqqwwSY/edit#gid=0" target="_blank"><i class='app-menu__icon bx bx-task'></i><span
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="widget-small info coloured-icon"><i class='icon bx bxs-data fa-3x'></i>
                                <div class="info">
                                    <h4>Tổng sản phẩm</h4>
                                    <p><b>${requestScope.book} sản phẩm</b></p>
