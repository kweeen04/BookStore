                ...
                <div class="col-md-12">
                    <div class="tile">
                        ...
                        <div class="tile-body">
                            ...
                            <form class="row" action="bookmanager?action=insertbook" method="POST">
                                <div class="form-group col-md-3">
                                    <label class="control-label">Mã sản phẩm </label>
                                    <input class="form-control" name="book_id" type="text" placeholder="">
                                </div>
                                <div class="form-group col-md-3">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input class="form-control" name="img_url" type="text">
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="control-label">Ngày xuất bản</label>
                                    <input class="form-control" name="public_date" type="date">
                                </div>
                                ...
                                &nbsp;
                                <a class="btn btn-cancel" href="bookmanager?action=list">Hủy bỏ</a>
                            </form>
                        </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12" >
                                ...
                                <form action="bookmanager?action=insertgenre" method="post"> 
