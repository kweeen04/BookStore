<%-- 
    Document   : login
    Created on : Mar 3, 2024, 10:43:33 AM
    Author     : ADMIN
--%>
                                ...
                                <form action="user?action=checkLogin" method="POST">
                                    ...
                                    <div class="login_submit">
                                        ...
                                        <button type="submit">Đăng nhập</button>
                                            ...
                                            <div style="padding-top: 10px">   <a href="https://accounts.google.com/o/oauth2/auth?scope=email&redirect_uri=http://localhost:9999/BookWeb/LoginGoogleHandler&response_type=code
		   &client_id=1016766770823-0vldd17mtg12uk474uo8rrecaesqpole.apps.googleusercontent.com&approval_prompt=force">Login With Google</a></div>    
                        </div>    
                    </div>
                    <!--login area start-->
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="account_form register">
                            ...
                            <form action="user?action=signup" method="POST">
                                ...
                                <p>   
                                    <label>Email <span>*</span></label>
                                        <input type="email" name="user_email" value="${requestScope.googleEmail}">
                                    </p>
                                <p>   
                                    <label>Mật khẩu <span>*</span></label>
