<%-- 
    Document   : checkout
    Created on : Mar 3, 2024, 10:31:26 AM
    Author     : ADMIN
--%>
                        ...
                        <div class="row">
                            <div class="col-lg-5 col-md-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 mb-20">
                                        ...
                                        <input readonly="" name = "name" value="${sessionScope.user.user_name}" type="text">
                                        <input type="hidden" name="name" value="${sessionScope.user.user_name}">
                                    </div>
                                    <div class="col-lg-12 mb-20">
                                        <label> Email <span>*</span></label>
                                        <input name="email" readonly="" value="${sessionScope.user.user_email}" type="text">
                                        <input type="hidden" name="email" value="${sessionScope.user.user_email}">
                                    </div>
                                    <div class="col-lg-12 mb-20">
                            ...
                            <div class="col-lg-7 col-md-7">
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach items="${o.items}" var="i">
                                                <tr>
                                                    <td> ${i.book.book_name} <strong> × ${i.quantity}</strong></td>
                                                    <td> ${i.book.book_price * i.quantity }</td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                        ...
                                        <c:if test="${sessionScope.cart!=null}">
                                            ...
                                            <input type="hidden" name="total" value="${sessionScope.total + 30000}">
                                </div>
                                <div class="payment_method">
                                    ...
                                    <div class="panel-default">
                                        <input id="payment_defult" value="paypal" name="payment_method" type="radio"
                                               data-target="createp_account" />
                                        <label for="payment_defult" data-toggle="collapse" data-target="#collapsedefult"
