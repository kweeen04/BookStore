    ...
    <div class="offcanvas_menu_wrapper">
        ...
        <div id="menu" class="text-left ">
            <ul class="offcanvas_main_menu">
                ...
                <li class="active">
                    <a href="book?action=listAll">Sản phẩm</a>
                </li>
        ...
        <div class="container-fluid">
            <div class="middel_inner">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4">
                        <div class="logo">
                            <a href="home"><img src="assets/img/logo/logo1.png" alt="" class="h-25 w-25"></a>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="cart_area">
                ...
                <div class="main_menu"> 
                    <nav>  
                        <ul>
                            ...
                            <li class="mega_items"><a href="book?action=listAll">Sản phẩm</a>
                            </li>
                        </ul> 
                    </nav> 
                </div>
                    ...
                    <div class="main_menu"> 
                        <nav>  
                            <ul>
                                ...
                                <li><a href="book?action=listAll">Sản phẩm</a></li>
                                <li><a href="about">Chúng tôi</a></li>
                                <li><a href="contact">Liên hệ</a></li>
                            </ul>   
                        </nav> 
